...
struct FloatingPopover<Item, PopoverContent>: ViewModifier where Item: Identifiable, PopoverContent: View {
  ...
  private class ContentViewController<V>: UIHostingController<V>, UIPopoverPresentationControllerDelegate
  where V: View {
...
extension View {
  ...
  @ViewBuilder
  public func floatingPopover<Item: Identifiable>(
    item: Binding<Item?>,
