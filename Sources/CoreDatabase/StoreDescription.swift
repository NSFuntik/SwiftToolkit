...
extension NSPersistentStoreDescription {
  ...
  public static func localData(
    ...
    setup: (NSPersistentStoreDescription) -> Void = { _ in }
  ...
  public static func cloudWithShare(
    _ name: String,
    identifier: String,
    setup: (
      _ cloud: NSPersistentStoreDescription,
      _ share: NSPersistentStoreDescription
    ) -> Void = { _, _ in }
  ) -> [NSPersistentStoreDescription] {
  ...
  public static func transientStore(
    _ configuration: Configuration? = nil,
    setup: (NSPersistentStoreDescription) -> Void = { _ in }
  ) -> NSPersistentStoreDescription {
...
extension NSPersistentStoreDescription {
  ...
  fileprivate static var applicationSupportDirectory: String {
