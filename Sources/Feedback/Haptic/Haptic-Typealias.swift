...
extension View {
  ...
  public func haptic<V>(_ style: HapticStyle, value: V) -> some View where V: Equatable {
  ...
  ///   - events: The events representing the haptic feedback
  ///   - value: The value to observe for changes
  public func haptic<V>(_ events: [HapticEvent], value: V) -> some View where V: Equatable {
  ...
  ///   - pattern: The pattern representing the haptic feedback
  ///   - value: The value to observe for changes
  public func haptic<V>(_ pattern: CHHapticPattern, value: V) -> some View where V: Equatable {
  ...
  ///   - url: The url representing the haptic feedback pattern
  ///   - value: The value to observe for changes
  public func haptic<V>(_ url: URL, value: V) -> some View where V: Equatable {
